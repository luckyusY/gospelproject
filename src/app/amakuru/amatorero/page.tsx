...
export default async function AmatoreroPage() {
    const { data } = await supabase
        .from("articles")
        .select("*")
        .eq("is_published", true)
        .eq("category", "amatorero")
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                <div className="container">
                    <h1 className={styles.pageTitle}>Amatorero</h1>
                    <p className={styles.pageDesc}>Amakuru y&apos;amatorero n&apos;ibikorwa by&apos;itorero mu Rwanda.</p>
                    <nav className={styles.catNav} aria-label="Ibyiciro by'amakuru">
                        ...
                        <Link href="/amakuru/amatorero"       className={`${styles.catLink} ${styles.catLinkActive}`}>Amatorero</Link>
