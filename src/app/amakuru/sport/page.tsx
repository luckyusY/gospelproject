...
export const metadata: Metadata = buildMeta({
    title: "Sport",
    description: "Amakuru ya sport, imikino n'ibikorwa by'urubyiruko bifite indangagaciro za Gikristu.",
    path: "/amakuru/sport",
});
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                <div className="container">
                    <h1 className={styles.pageTitle}>Sport</h1>
                    <p className={styles.pageDesc}>
                        Amakuru ya sport, imikino n&apos;ibikorwa by&apos;urubyiruko bifite indangagaciro za Gikristu.
                    </p>
                    <nav className={styles.catNav} aria-label="Ibyiciro by'amakuru">
                        ...
                        <Link href="/amakuru/amakorali" className={styles.catLink}>Amakorali</Link>
                        <Link href="/amakuru/amatorero" className={styles.catLink}>Amatorero</Link>
                        <Link href="/amakuru/abanyempano" className={styles.catLink}>Abanyempano</Link>
                        <Link href="/amakuru/ibitaramo" className={styles.catLink}>Ibitaramo</Link>
                        <Link href="/amakuru/sport" className={`${styles.catLink} ${styles.catLinkActive}`}>Sport</Link>
            ...
            <div className="container">
                    ...
                    <Link href={`/amakuru/${featured.slug}`} className={styles.featured}>
                        <div className={styles.featuredImgWrap}>
                            {featured.image_url ? (
                                ...
                                <div className={styles.imgPlaceholder}>News</div>
                            )}
                        </div>
                ...
                {rest.length > 0 ? (
                    ...
                    !featured && <p className={styles.empty}>Nta makuru ya sport abonetse ubu. Subira vuba!</p>
                )}
            </div>
        </div>
    );
