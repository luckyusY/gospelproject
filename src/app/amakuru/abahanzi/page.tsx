...
export default async function AbahanziPage() {
    const { data } = await supabase
        .from("articles")
        .select("*")
        .eq("is_published", true)
        .eq("category", "abahanzi")
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                <div className="container">
                    <h1 className={styles.pageTitle}>Abahanzi</h1>
                    <p className={styles.pageDesc}>Amakuru mashya y&apos;abahanzi b&apos;Imana mu Rwanda no ku isi yose.</p>
                    <nav className={styles.catNav} aria-label="Ibyiciro by'amakuru">
                        <Link href="/amakuru"               className={styles.catLink}>Byose</Link>
                        <Link href="/amakuru/abahanzi"      className={`${styles.catLink} ${styles.catLinkActive}`}>Abahanzi</Link>
