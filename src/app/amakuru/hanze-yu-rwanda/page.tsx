...
export default async function HanzeYuRwandaPage() {
    const { data } = await supabase
        .from("articles")
        .select("*")
        .eq("is_published", true)
        .eq("category", "hanze-yu-rwanda")
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                <div className="container">
                    <h1 className={styles.pageTitle}>Hanze y&apos;u Rwanda</h1>
                    <p className={styles.pageDesc}>Amakuru y&apos;Ubukristu avuye mu bihugu byo hanze y&apos;u Rwanda.</p>
                    <nav className={styles.catNav} aria-label="Ibyiciro by'amakuru">
                        ...
                        <Link href="/amakuru/hanze-yu-rwanda" className={`${styles.catLink} ${styles.catLinkActive}`}>Hanze y&apos;u Rwanda</Link>
                    </nav>
                </div>
            </div>
