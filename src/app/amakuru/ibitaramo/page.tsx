...
export const metadata: Metadata = buildMeta({
    title:       "Ibitaramo",
    description: "Amakuru y'ibitaramo bya Gikrisitu mu Rwanda no ku isi yose.",
    path:        "/amakuru/ibitaramo",
});

export default async function IbitaramoPage() {
    const { data } = await supabase
        .from("articles")
        .select("*")
        .eq("is_published", true)
        .eq("category", "ibitaramo")
        ...
        <div className={styles.page}>
            <div className={styles.pageHeader}>
                <div className="container">
                    <h1 className={styles.pageTitle}>Ibitaramo</h1>
                    <p className={styles.pageDesc}>Amakuru y&apos;ibitaramo bya Gikrisitu mu Rwanda no ku isi yose.</p>
                    <nav className={styles.catNav} aria-label="Ibyiciro by'amakuru">
                        ...
                        <Link href="/amakuru/ibitaramo"     className={`${styles.catLink} ${styles.catLinkActive}`}>Ibitaramo</Link>
