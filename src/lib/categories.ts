...
const DEFAULT_ARTICLE_CATEGORY_SEEDS: CategorySeed[] = [
    ...
    { name: "Ubuzima", slug: "ubuzima", color: "#0D9488", nav_group: "amakuru", sort_order: 9 },
    { name: "Ubukungu", slug: "ubukungu", color: "#CA8A04", nav_group: "amakuru", sort_order: 10 },
    { name: "Ibigwi", slug: "ibigwi", color: "#1F1F1F", nav_group: "ibigwi", sort_order: 0 },
...
const DEFAULT_CATEGORY_DESCRIPTIONS: Record<string, string> = {
    ...
    ubuzima: "Amakuru n'inama ku buzima bwiza bw'umubiri n'umutima.",
    ubukungu: "Amakuru y'ubukungu, ubucuruzi n'iterambere.",
    ibigwi: "Inkuru z'ibigwi n'ibikorwa by'abakristu batanze urugero rwiza.",
