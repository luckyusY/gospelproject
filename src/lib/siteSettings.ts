...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
    ...
    },
    {
        ...
        description: "Ad image shown between the stories and the live radio. Recommended size: 970 x 250 px.",
        group: "ads",
        input: "text",
    },
    {
    ...
    {
        key: "ad_home_top_badge",
        value: "Live Radio",
        label: "Banner overlay badge",
        description: "Small label shown on top of the homepage banner ad image",
        group: "ads",
        input: "text",
    },
    {
        key: "ad_home_top_headline",
        value: "Urugero Online Radio",
        label: "Banner overlay headline",
        description: "Main title shown over the homepage banner ad image",
        group: "ads",
        input: "text",
    },
    {
        key: "ad_home_top_description",
        value: "Indirimbo z'Imana, inyigisho, amakuru na gahunda za buri munsi.",
        label: "Banner overlay description",
        description: "Short text shown over the homepage banner ad image",
        group: "ads",
        input: "textarea",
    },
    {
        key: "ad_home_top_cta",
        value: "Umva nonaha",
        label: "Banner overlay button text",
        description: "Button text shown over the homepage banner ad image",
        group: "ads",
        input: "text",
    },
    {
        ...
        description: "Ad image shown after the hero section. Recommended size: 1080 x 1080 px or 1200 x 1200 px.",
        group: "ads",
        input: "text",
    },
    {
    ...
    {
        key: "ad_home_sidebar_badge",
        value: "Kwamamaza",
        label: "Square ad overlay badge",
        description: "Small label shown on top of the square ad image",
        group: "ads",
        input: "text",
    },
    {
        key: "ad_home_sidebar_headline",
        value: "Urugero Gospel News",
        label: "Square ad overlay headline",
        description: "Main title shown over the square ad image",
        group: "ads",
        input: "text",
    },
    {
        key: "ad_home_sidebar_description",
        value: "Amakuru, radio, sport n'ibiganiro bya Gospel.",
        label: "Square ad overlay description",
        description: "Short text shown over the square ad image",
        group: "ads",
        input: "textarea",
    },
    {
        key: "ad_home_sidebar_cta",
        value: "Menya byinshi",
        label: "Square ad overlay button text",
        description: "Button text shown over the square ad image",
        group: "ads",
        input: "text",
    },
    {
